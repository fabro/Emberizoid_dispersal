...
library(letsR)
#####upload data
setwd("~/Documents/HWI-DISP_masterscript/Distance/")
...
comp.hwi<-comparative.data(hwitree, hwimigrants_mid, names.col="sp", vcv.dim=T, warn.dropped=F)
#
modeldistance<-pgls(distances_mid~HWI,lambda = "ML",data = comp.hwi)#simple model where the geodesic migration distance is predicted by HWI
